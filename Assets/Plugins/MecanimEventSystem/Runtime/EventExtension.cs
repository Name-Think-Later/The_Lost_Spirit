...
namespace zFrame.Event
{
    public static class EventExtension
    {
        ...
        public static EventState SetTarget(this Animator animator, string clipName) {
            EventInfo a_EventInfo = EventHandler.GetAnimationInfo(animator, clipName);
        ...
        public static void RemoveListener(
            ...
            Action<AnimationEvent> action,
            string                 clipName,
            int                    frame = -1
        ) {
            EventInfo a_EventInfo = EventHandler.GetAnimationInfo(animator, clipName, false);
            if (null != a_EventInfo) {
